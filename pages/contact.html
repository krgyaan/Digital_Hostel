                ...
                <div class="lg:w-1/2 lg:mx-6">
                    ...
                    <div class="mt-6 w-80 md:mt-8">
                        ...
                        <div class="flex mt-4 -mx-1.5 ">
                            <a class="mx-1.5 text-gray-400 transition-colors duration-300 transform hover:text-blue-400"
                                href="#">
                                <i class="fa-brands fa-twitter"></i>
                            </a>

                            <a class="mx-1.5 text-gray-400 transition-colors duration-300 transform hover:text-blue-600"
                                href="#">
                                <i class="fa-brands fa-linkedin-in"></i>
                            </a>

                            <a class="mx-1.5 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                                href="#">
                                <i class="fa-brands fa-facebook-f"></i>
                            </a>

                            <a class="mx-1.5 text-gray-400 transition-colors duration-300 transform hover:text-red-500"
                                href="#">
                    ...
                    <div
                        ...
                        <form class="mt-6">
                            <div class="flex-1">
                                ...
                                <input type="text" placeholder="Gyan Prakash Kumar"
                            ...
                            <div class="w-full mt-6">
                                ...
                                <textarea
                                    class="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md resize-none md:h-48 focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
